...
HD_PWD='D:/FPGA project/MyDemo/My_Demo/My_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log My_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source My_Demo.tcl -notrace
