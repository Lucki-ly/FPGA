...
HD_PWD='D:/FPGA project/MyDemo/My_Demo/My_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log My_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source My_Demo.tcl
